<?php
    ...
    $historys = $historyController->GetAllHistory();
...
<body>
    ...
    <div id="history" class="container">
        ...
        <?php
            if (empty($historys))   {
                echo '<div class="alert alert-warning" role="alert">There is currently no purchase history</div>';
            }
        ?>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5 text-md-end">
                                <h5 class="card-title">Purchased by : <?php echo $userController->GetUserById(intval($history['user_id']))['username']; ?></h5>
